...
import 'package:vapidemo/paginationdemo/pagedemo_controller.dart';

class PageDemoScreen extends StatelessWidget {
  PageDemoScreen({Key? key}) : super(key: key);
  PageDemoController postUserController = Get.put(PageDemoController());
  @override
