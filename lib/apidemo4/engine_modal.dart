...
//
//     final engineApiDemo = engineApiDemoFromJson(jsonString);

import 'dart:convert';

List<EngineApiDemo> engineApiDemoFromJson(String str) =>
    List<EngineApiDemo>.from(
        json.decode(str).map((x) => EngineApiDemo.fromJson(x)));

String engineApiDemoToJson(List<EngineApiDemo> data) =>
...
class EngineApiDemo {
  ...
  factory EngineApiDemo.fromJson(Map<String, dynamic> json) => EngineApiDemo(
        id: json["id"],
        active: json["active"],
        stages: json["stages"],
